...
- Create Angular project with ng: `ng new dev_mind_speed_game.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`dev_mind_speed_game.client.esproj`).
